...
<div class="hero-card">
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 12px;">
        <span class="status-badge status-badge-ready">🟢 Step 1 of 5</span>
        <span style="font-size: 0.8rem; color: #6B7280; font-weight: 500;">Vision &amp; Mission Identity</span>
    </div>
    <div class="hero-title">Vision &amp; Mission Identity</div>
    <div class="hero-subtitle">Establish the core values, long-term vision, target audience, and brand promise of your startup idea.</div>
</div>
...
# ---------------------------------------------------------------
selected_model, llm_engine, server_host = render_premium_header_config(1)
