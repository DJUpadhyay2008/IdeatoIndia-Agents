...
<div class="hero-card">
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 12px;">
        <span class="status-badge status-badge-ready">🟢 Step 3 of 5</span>
        <span style="font-size: 0.8rem; color: #6B7280; font-weight: 500;">Product Requirements (PRD)</span>
    </div>
    <div class="hero-title">Product Requirements (PRD)</div>
    <div class="hero-subtitle">Define functional/non-functional requirements, target user personas, key product modules, and acceptance criteria.</div>
</div>
...
# ---------------------------------------------------------------
selected_model, llm_engine, server_host = render_premium_header_config(3)
