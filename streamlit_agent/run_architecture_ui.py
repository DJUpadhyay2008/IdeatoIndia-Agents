# Standalone runner for the Technical Architecture Agent
...
# Set Page Config
st.set_page_config(
    page_title="IdeaToIndia — Standalone Technical Architecture Agent",
    page_icon="🏗️",
    layout="wide",
)
...
# ---------------------------------------------------------------
st.markdown("""
<div style="background: radial-gradient(circle at 50% 30%, #f0fdf4 0%, #e0f2fe 50%, #fffbeb 100%); padding: 2rem; border-radius: 16px; border: 1px solid #e2e8f0; margin-bottom: 2rem; text-align: center;">
    <div style="font-weight: 800; font-size: 0.85rem; letter-spacing: 0.08em; text-transform: uppercase; color: #0284c7; margin-bottom: 0.5rem;">🏗️ IdeaToIndia Standalone Agent</div>
    ...
    <div style="color: #475569; font-size: 0.95rem; max-width: 600px; margin: 0 auto;">
        Design cloud topologies, database models, compliance structures, and deployment pipelines for your startup idea.
    </div>
</div>
