# Standalone runner for the Planning Agent
...
# Set Page Config
st.set_page_config(
    page_title="IdeaToIndia — Standalone Planning Agent",
    page_icon="📋",
    layout="wide",
)
...
# ---------------------------------------------------------------
st.markdown("""
<div style="background: radial-gradient(circle at 50% 30%, #fffbeb 0%, #fef3c7 50%, #fff7ed 100%); padding: 2rem; border-radius: 16px; border: 1px solid #e2e8f0; margin-bottom: 2rem; text-align: center;">
    <div style="font-weight: 800; font-size: 0.85rem; letter-spacing: 0.08em; text-transform: uppercase; color: #d97706; margin-bottom: 0.5rem;">📋 IdeaToIndia Standalone Agent</div>
    <div style="font-size: 2.2rem; font-weight: 800; color: #0f172a; margin-bottom: 0.5rem; font-family: 'Playfair Display', serif;">Launch Plan &amp; Roadmap</div>
    <div style="color: #475569; font-size: 0.95rem; max-width: 600px; margin: 0 auto;">
        Map out development phases, budget allocations, operational resource constraints, and startup launch timelines.
    </div>
</div>
...
with st.container(border=True):
    ...
    shared_idea = st.text_area(
        "Describe your core business idea (automatically shared with the Planning Agent)",
...
# ---------------------------------------------------------------
# Render standalone Planning Agent
# ---------------------------------------------------------------
